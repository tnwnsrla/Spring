...
<body>
	...
	<form role="form" action="/notice/modify" method="post">
		...
		<div class="mb-3"> <%-- 작성 제목 --%>
		  ...
		  <input name="notice_title" type="text" class="form-control" id="exampleFormControlInput1" placeholder="50글자 미만으로 입력해주세요." value="${notice.notice_title}">
		</div>
		<div class="mb-3"><%-- 작성자 --%>
		  <label for="exampleFormControlInput1" class="form-label">작성자</label>
		  <input name="notice_userid" type="text" class="form-control" id="exampleFormControlInput1" value="${notice.notice_userid}" readonly ><%--Security로 해야할 부분 --%>
		</div>
		<%-- <div class="mb-3">작성일
		  <label for="exampleFormControlInput1" class="form-label"></label>
		  <input name="notice_regdate" type="text" class="form-control" id="exampleFormControlInput1" value="<fmt:formatDate value='${notice.notice_regdate}' pattern='yyyy-MM-dd'/>" readonly >
		</div> --%>  
		<div class="mb-3"><%-- 작성내용 --%>
		  <label for="exampleFormControlTextarea1" class="form-label">내용</label>
		  <textarea name="notice_content"class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="500글자 미만으로 입력해주세요.">${notice.notice_content}</textarea>
		</div>
		  ...
		  $(arr).each(function(i, attach){
		    //image type
			  if(attach.fileType){
			      ...
			      str += "<li data-path='"+attach.na_uploadPath+"' data-uuid='"+attach.na_uuid+"' "
			      str +=" data-filename='"+attach.na_fileName+"' data-type='"+attach.na_fileType+"' ><div>";
			      str += "<span> "+ attach.na_fileName+"</span>";
